...
function Home()
{
  async function powerEventComponents(page)
  {
    ...
    openPage(page, "https://ualbany-ieee-student-branch.github.io/UAlbany-IEEE-2023-Website/events/home");await new Promise(r => setTimeout(r, 500));
  ...
  async function powerAboutComponents(page)
  {
    ...
    openPage(page, "https://ualbany-ieee-student-branch.github.io/UAlbany-IEEE-2023-Website/about");
  ...
  async function powerBoardComponents(page)
  {
    ...
    document.getElementById("cpu").className = "charged-cpu";
    await new Promise(r => setTimeout(r, 1500));
    openPage(page, "https://ualbany-ieee-student-branch.github.io/UAlbany-IEEE-2023-Website/members");
    await new Promise(r => setTimeout(r, 500));
    document.getElementById("pcb").style.visibility = "hidden";
  }
